<div id="categories_container" class="space-y-8">
    <h2 class="flex items-center mb-6 text-2xl text-black font-bold">
        <span
            class="mr-3 font-bold text-2xl text-white rounded-full w-8 h-8 bg-blue-600 flex items-center justify-center ">2</span>
        หมวดหมู่การประเมิน
    </h2>

    <!-- Category Block -->
    <div
        class="category_block bg-white p-8 rounded-lg drop-shadow-md border-l-4 border-blue-600 hover:shadow-xl transition-shadow duration-300">
        ...
        <div class="space-y-6 mb-4 ml-2">
            ...
            <div>
                ...
                <div class="relative">
                    <select id="main_categories" name="main_categories" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" min="0" step="0.5" name="sub_category_score"
        ...
        <div class="evaluation_lists_container space-y-6 mt-8">
            ...
            <div
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">ค่าน้ำหนัก<span
                                class="text-red-500">*</span></label>
